...
\begin{figure}
\centerline{\includegraphics[width=19pc]{manuscript/Figures/Background_GeoLocation_H_CR.png}}
...
\begin{figure}
\centerline{\includegraphics[width=19pc]{manuscript/Figures/CR_ecPoint_product.png}}
...
\label{CR_ecPoint_product}
\end{figure}

\subsubsection{Subjective Verification}

\begin{figure}
\centerline{\includegraphics[width=39pc]{manuscript/Figures/CR_ecPoint_product.png}}
