...
\subsection{First phase: the real-time phase}
 \begin{figure}
\centerline{\includegraphics[width=19pc]{manuscript/Figures/Fig5.png}}
\caption{Timeline of the trial phases. The first phase, the "real-time phase", took place between 2018 and 2019 and lasted 12 months. Th second phase, the "offline phase", took place between 2019 and 2021 and lasted 15 months.}
\label{Fig4}
\end{figure}
 ...
 The trial started with a one month "Remote training" phase. The materials provided to IMN and OMSZ are listed in Table 1. 
 
 
 
 
 depending on the meteorological service experience with PEFs, was more involving for Costa Rica. The raining material 
