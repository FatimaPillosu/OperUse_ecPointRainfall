...
\caption{Like Fig.\ref{UND_EFF_estimated}, but it includes the results of the experiment with IMN and OMSZ. Such results show that the gap in the UND-EFF relationship between ecPoint and traditional ensemble-based forecasts is greater than it was estimated at the beginning of the experiment as centres with different ensemble-based forecasts understanding levels performed similarly.}
